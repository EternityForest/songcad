...
import { Header, type HeaderJSON } from './Header'
...
export class Midi {
  ...
  constructor(midiArray?: ArrayLike<number> | ArrayBuffer) {
    ...
    if (midiArray) {
      ...
      const midiArrayLike: ArrayLike<number> =
        midiArray instanceof ArrayBuffer ? new Uint8Array(midiArray) : midiArray
...
export type { TrackJSON } from './Track'
export type { HeaderJSON } from './Header'
/**
